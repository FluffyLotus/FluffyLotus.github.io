...
function createBuildingUpgrade(name, description, maxLevel, shardFormula) {
    var item = new buildingUpgrade();

    item.id = buildingUpgradeId++;
    item.name = name;
...
function createBuildingUpgrade_Grade(name, description, maxLevel, shardFormula) {
    var item = new buildingUpgrade();
...
function createBuildingUpgrade_ParticleOutput(name, description, maxLevel, shardFormula, particleOutput, levelMulFormula) {
    var item = new buildingUpgrade();
...
function createBuildingUpgrade_Reward(name, description, maxLevel, shardFormula, reward, levelMulFormula) {
    var item = new buildingUpgrade();
