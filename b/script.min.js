...
var previousDrawCanvas=0;var deltaTime=0;var isDebug=false;function loadApp(){uiSetHardTooltip(TOOLTIP_TYPE_MESSAGE,"Click on a forest or mountain to gain resources.");glInitAll();if(isDebug){for(var t=0;t<resources.length;t++)
